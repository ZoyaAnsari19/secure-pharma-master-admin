...
type ProductSalesBarChartProps = {
  data: ProductSalesDatum[];
  metric?: Metric;
};
        ...
        >
          ...
          <Tooltip
            formatter={(value: number) => {
              if (metric === "revenue") {
                return [`₹${value.toLocaleString()}`, METRIC_LABEL[metric]];
              }
              return [value.toLocaleString(), METRIC_LABEL[metric]];
            }}
            contentStyle={{
